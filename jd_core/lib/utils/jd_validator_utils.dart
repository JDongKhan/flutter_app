...
import 'package:jd_core/utils/regex/jd_regex_constants.dart';
import 'package:jd_core/utils/regex/jd_regex_utils.dart';

import 'jd_transform_utils.dart';
...
class ValidatorUtils {
  ...
  static bool isOneAKind(dynamic s) {
    if ((s is String || s is List) && !ObjectUtils.isEmpty(s)) {
      var first = s[0];
      var isOneAKind = true;
      for (var i = 0; i < s.length; i++) {
