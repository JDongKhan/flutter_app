...
class JDTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  final TabBarAlignType alignType;
...
class _TabBarState extends State<JDTabBar> {
  ...
  @override
  void didUpdateWidget(JDTabBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isScrollable) {
      ...
      tabBar = Container(
          alignment: _alignType(widget.alignType ?? TabBarAlignType.center),
  ...
  _alignType(alignType) {
    Alignment _type;
    switch (alignType) {
      case TabBarAlignType.left:
        _type = Alignment.centerLeft;
        break;
      case TabBarAlignType.center:
        _type = Alignment.center;
        break;
      case TabBarAlignType.right:
