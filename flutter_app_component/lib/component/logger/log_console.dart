...
class UIAndConsoleOutput extends LogOutput {
  ListQueue<RenderedEvent> renderedBuffer = ListQueue();
  var _currentId = 0;

  /// 构造方法私有化
  UIAndConsoleOutput._internal();

  MyOutputCallback outputCallback = null;
  static UIAndConsoleOutput get instance => _getInstance();
  static UIAndConsoleOutput _instance;
  static UIAndConsoleOutput _getInstance() {
    _instance ??= UIAndConsoleOutput._internal();
    return _instance;
  }

  void addOutputListener(MyOutputCallback outputCallback) {
