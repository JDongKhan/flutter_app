...
//          maskColor: Colors.red.withOpacity(0.5),
  ...
  Widget _buildSaixuan() {
    return Container(
      margin:
          EdgeInsets.only(left: MediaQuery.of(context).size.width / 4, top: 0),
      color: Colors.red,
      child: ListView(
...
//    List firstLevels = new List<int>.filled(15, 0);
                ...
                : ListView(
                    children: secondLevels.map(
                      (item) {
                        ...
                        return gestureDetector1(
                            index, itemOnTap, firstLevels, item);
                      },
                    ).toList(),
                  ),
          ),
  ...
  GestureDetector gestureDetector0(
      int index, void itemOnTap(String selectValue), item) {
    return GestureDetector(
      onTap: () {
  ...
  GestureDetector gestureDetector1(
      int index, void itemOnTap(String selectValue), List firstLevels, item) {
    return GestureDetector(
      onTap: () {
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  color:
                      goodsSortCondition.isSelected ? Colors.red : Colors.black,
                ),
              ),
            ),
