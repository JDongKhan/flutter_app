...
class JDShopDetailInfoWidget extends StatefulWidget {
  final JDShopInfo shopInfo;
  final JDShopDetailNavigatorController navigatorController;
  JDShopDetailInfoWidget(
    this.shopInfo, {
    this.navigatorController,
  });
  @override
  _JDShopDetailInfoWidgetState createState() => _JDShopDetailInfoWidgetState();
}
