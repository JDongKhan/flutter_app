...
import 'package:flutter_app_component/demo/sports/home/widget/sports_home_video_item.dart';
...
class _SportsHomeVideoPageState extends State<SportsHomeVideoPage> {
  ...
  Widget build(BuildContext context) {
    return ProviderWidget<SportsHomeVideoVm>(
  ...
  ///文本广告
  Widget _buildTextAdWidget(SportsHomeVideoVm vm) {
    return SliverToBoxAdapter(
      child: Container(
        height: 40,
  ...
  Widget _buildGuessLikeWidget(SportsHomeVideoVm vm) {
    return SliverToBoxAdapter(
      child: Container(
        height: 170,
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return SportsHomeVideoItem(video);
          },
        ),
      ),
    );
  ...
  Widget _recentlyUpdateGridView(SportsHomeVideoVm vm) {
    return SliverGrid(
      //Grid
