...
class DiDiScrollable extends StatefulWidget {
  /// Creates a widget that scrolls.
  ///
  /// The [axisDirection] and [viewportBuilder] arguments must not be null.
  const DiDiScrollable({
    Key key,
  ...
  static Future<void> ensureVisible(
    ...
    ScrollableState scrollable = DiDiScrollable.of(context);
    while (scrollable != null) {
      ...
      scrollable = DiDiScrollable.of(context);
    }
...
class ScrollableState extends State<DiDiScrollable>
  ...
  bool _shouldUpdatePosition(DiDiScrollable oldWidget) {
  ...
  @override
  void didUpdateWidget(DiDiScrollable oldWidget) {
...
class ScrollAction extends Action<ScrollIntent> {
  ...
  void invoke(ScrollIntent intent) {
    final ScrollableState state = DiDiScrollable.of(primaryFocus.context);
    assert(state != null,
