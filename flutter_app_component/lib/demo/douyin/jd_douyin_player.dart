...
class JDDouyinPlayer extends StatefulWidget {
  JDDouyinPlayer({this.url, this.loop = true});
  final String url;
  final bool loop;
  @override
  _JDDouyinPlayerState createState() => _JDDouyinPlayerState();
}

class _JDDouyinPlayerState extends State<JDDouyinPlayer>
  ...
  @override
  void didUpdateWidget(covariant JDDouyinPlayer oldWidget) {
