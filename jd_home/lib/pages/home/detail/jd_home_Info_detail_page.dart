...
import 'package:jd_home/pages/home/addInfo/jd_home_add_info_page.dart';

class JDHomeInfoDetailPage extends StatefulWidget {
  JDHomeInfoDetailPage({
    this.userInfo,
  });
  ...
  @override
  _JDHomeInfoDetailPageState createState() => _JDHomeInfoDetailPageState();
}

class _JDHomeInfoDetailPageState extends State<JDHomeInfoDetailPage>
    with JDLoadingMixin {
  @override
  void initState() {
    super.initState();
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: JDButton(
                                action: () {
                                  JDNavigationUtil.push(JDHomeAddInfoPage());
                                },
                                width: 60,
                                height: 60,
