...
class JDNestedScrollView5Demo extends StatefulWidget {
  @override
  _JDNestedScrollView5DemoState createState() =>
      _JDNestedScrollView5DemoState();
}

class _JDNestedScrollView5DemoState extends State<JDNestedScrollView5Demo> {
              ...
              SliverOverlapAbsorber(
                ...
                sliver: SliverAppBar(
                  ...
                  bottom: PreferredSize(
                    preferredSize: Size(0, kMinInteractiveDimension),
                    child: Container(
                      color: Colors.red,
                      height: 50,
                      child: TabBar(
