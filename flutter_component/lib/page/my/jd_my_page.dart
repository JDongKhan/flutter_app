...
import 'package:flutter_component/page/setting/jd_setting_page.dart';
...
class _JDMyPageState extends State<JDMyPage> with _CounterStateMixin,AutomaticKeepAliveClientMixin {
  ...
  Widget _buildStyle1AppBar() {
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        title: const Text('我的',style: TextStyle(color: Colors.white),),
        background: Image.asset(JDAssetBundle.getImgPath("user_head"), fit: BoxFit.cover,),
      ),
    );
  }
  ...
  List<Widget> _buildAction() => <Widget>[
    IconButton(icon: Icon(Icons.settings,color: _appBarStyle == 0 ? Colors.white : Colors.black12 ,),onPressed: () {
  ...
  Widget _buildMesnuGrid() {
    return Container(
      ...
      child: GridView.count(
        ...
        children: _headMenu.map((e) => Container(
          color: Colors.transparent,
          child: InkWell(
            onTap: () {
            },
            child: Tab(
              icon: Icon(e['icon'] as IconData,color: Colors.white,),
              child: Text(e['title'].toString(),style: const TextStyle(color: Colors.white),),
            ),
          ),
        )).toList(),
      ),
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Container(
                ...
                child: Text('发布需求',style: TextStyle(fontSize: 14,color: Colors.black),),
              ),
              subtitle: Text('免费获取方案和报价',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.black54),),
        ...
        child: Stack(
          children: <Widget>[
            ...
            CustomScrollView(
              ...
              slivers: <Widget>[
                //AppBar，包含一个导航栏
                _appBarStyle == 0 ? _buildStyle0AppBar():_buildStyle1AppBar(),
