...
import 'package:flutter_component/page/buiness/jd_business_page.dart';
import 'package:flutter_component/page/home/jd_home_page.dart';
import 'package:flutter_component/page/leftdrawer/jd_left_drawer.dart';
import 'package:flutter_component/page/my/jd_my_page.dart';
import 'package:flutter_component/page/discover/jd_discover_page.dart';
...
class JDScaffoldPageState extends State<JDScaffoldPage> with SingleTickerProviderStateMixin {
...
//          index: _selectedIndex,
        ...
        bottomNavigationBar: BottomNavigationBar( // 底部导航
          items: _tabs.map((e) => BottomNavigationBarItem(icon: Icon(e["icon"] as IconData), title: Text(e["title"].toString()))).toList(),
