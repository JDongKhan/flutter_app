...
class _JDSettingPageState extends State {
    ...
    return Scaffold(
      ...
      body: ListTileTheme(
        ...
        child: ListView(
          ...
          context.watch<JDGlobal>().isLogin ? Container(
                ...
                trailing: rightTitle == null
                    ...
                    : Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Expanded(child: Text(rightTitle,style: const TextStyle(fontSize: 12),),),
                            Icon(Icons.chevron_right)
                          ],
                        ),
                      ),
  ...
  void _showDialog() {
    PackageInfo.fromPlatform().then((PackageInfo packageInfo) {
      ...
      showDialog<dynamic>(context: context,builder: (context)=>_buildAboutDialog(appName,version,buildNumber));
    });
  }
  ...
  void _logoutAction(){
    showDialog<dynamic>(context: context,builder: (context) {
      return AlertDialog(
        title: Text("提示"),
